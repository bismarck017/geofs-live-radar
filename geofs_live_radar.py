...
(async function(){
  ...
  const SHOW_KEYWORDS = ["[U]","[UTP]","[P]","[PMC]","[SHL]","[NFS]","[RPAF]","[RNLAF]","[RNZAF]","[USAF]","[RAAF]","[tuAF]","[TuAF]","[TUAF]","[TASC]","[TaSC]","[UAC]","[UAEAF]","[CAEAF]","[USSR]","[BAF]","[PAF]","[RAF]","(U)","(UTP)","(P)","(PMC)","(RNLAF)","(RNZAF)","(SHL)","(NFS)","(RPAF)","(RAAF)","(USAF)","(tuAF)","(TuAF)","(TASC)","(TaSC)","(TUAF)","(UAC)","(UAEAF)","(CAEAF)","(USSR)","(BAF)","(PAF)","(RAF)"]; // add your keywords here // add your keywords here
